            ...
            <form action="saveEmpleado" method="POST">
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <c:choose>
                            <c:when test="${swEditar eq 1}">
                                <input type="password" class="form-control" name="password" id="password" value="${empleado.usuario.passUsuario}">
                            </c:when>
                            <c:otherwise>
                                ...
                                <c:forEach items="${lstPerfiles}" var="perfil">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" name="perfiles" value="${perfil.codigoPerfil}" <c:forEach items="${empleado.usuario.perfiles}" var="userperfil">
